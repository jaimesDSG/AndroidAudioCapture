...
extern int64_t video_size;
extern int64_t audio_size;
extern int64_t extra_size;
extern volatile int received_nb_signals;
extern int nb_frames_dup;
extern int nb_frames_drop;
...
#define PRINT_LIB_INFO(libname, LIBNAME, flags, level)                  \
    if (CONFIG_##LIBNAME) {                                             \
        ...
        if (flags & SHOW_VERSION) {                                     \
            ...
            LOGI("%slib%-11s %2d.%3d.%3d / %2d.%3d.%3d\n",            \
                   indent, #libname,                                    \
        ...
        if (flags & SHOW_CONFIG) {                                      \
            ...
            if (strcmp(FFMPEG_CONFIGURATION, cfg)) {                    \
                if (!warned_cfg) {                                      \
                    LOGW("%sWARNING: library configuration mismatch\n", \
                            indent);                                    \
                    warned_cfg = 1;                                     \
                }                                                       \
